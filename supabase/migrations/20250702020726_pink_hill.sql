/*
  # Certification Details System

  1. New Tables
    - `certification_details` table with one-to-one relationship to certifications
    - Stores detailed examination information using JSONB for flexibility
  ...
  4. Utility Functions
    - get_certification_details() for formatted output
    - search_certifications_by_topic() for topic-based searches
    - certifications_with_details view for easy joins
*/
...
-- This can be called manually after certifications exist
